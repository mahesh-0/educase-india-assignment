...
export default function SignUpPage() {
  ...
  return (
    <motion.div
      ...
      style={{ minHeight: '100vh', background: '#f7f8fa', padding: '40px 24px 24px' }}
    >
      <h1 style={{ fontSize: '26px', fontWeight: 700, color: '#111', lineHeight: 1.3, marginBottom: '28px' }}>
      ...
      <motion.div initial="initial" animate="animate" transition={{ staggerChildren: 0.06 }}>
        <motion.div variants={fieldVariants}>
          <InputField label="Full Name*" placeholder="Marry Doe" type="text" value={fields.fullName}
        ...
        <motion.div variants={fieldVariants}>
          <InputField label="Phone number*" placeholder="Marry Doe" type="tel" value={fields.phone}
        ...
        <motion.div variants={fieldVariants}>
          <InputField label="Email address*" placeholder="Marry Doe" type="email" value={fields.email}
        ...
        <motion.div variants={fieldVariants}>
          <InputField label="Password *" placeholder="Marry Doe" type="password" value={fields.password}
      ...
      <motion.div initial="initial" animate="animate" transition={{ staggerChildren: 0.06, delayChildren: 0.24 }}>
        <motion.div variants={fieldVariants}>
          <InputField label="Company name" placeholder="Marry Doe" type="text" value={fields.companyName}
